  ...
  return (
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2  '>Piri
            <span className='text-[#E36414] '>Eats</span>
            </h1>
            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
                <p className='bg-[#E36414] text-white rounded-full p-2 text-bold'>Free</p>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-0[400px] lg:w-[500px]'>
        ...
        <button className='bg-[#E36414] text-white hidden md:flex items-center py-2 rounded-2'>
