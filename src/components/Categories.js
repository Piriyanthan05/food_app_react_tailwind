...
const Categories = () => {
    ...
    return (
        <div className='max-w-[1520px] m-auto px-4 py-4'>
            <h1 className='text-orange-500 font-bold text-3xl text-center py-5'>Trending Categories</h1>
            <div className='grid grid-cols-2 md:grid-cols-6 gap-5 py-5 px-2'>
                {categories.map((item) => (
                    <div key={item.id} 
                    className='p-4 flex content-center items-center hover:scale-105 duration-300'>
